<?php
/* ----------------------------------------------------------------------
 * app/printTemplates/results/local/ca_objects_accession_list_objects_location_results.php
 * ----------------------------------------------------------------------
 *
 ...
 *
 * @name PHS Accession List Objects & Location V2.2.5
 * @type page
 * @pageSize letter 
 ...
 */
  ...
  $vers               = "PHS Accession List Objects & Location Results V2.2.5"; 
 ...
 //***** Begin Here ****
     ...
     while( $vo_result->nextHit()){
          ...
          if(!$the_object->get('ca_objects.is_deaccessioned')){// We only want to deal with non-deaccessioned objects...
           ...
           // because MultiCell leaves the pointer at the end of the cell   
           $y = $pdf->getY();
           $x = $pdf->getX();
 ...
 //echo "This Report is printed LANDSCAPE and requires double sided printing to us <i>Flip Up</i> to print correctly";
  exit;        
?>
