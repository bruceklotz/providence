 ...
 *
 * @name PHS Accession Sheet V1.1.10 Summary
 * @type page
 * @pageSize letter
 ...
 * ----------------------------------------------------------------------
 */
	$version = "PHS Accession Sheet V1.1.10 Summary"; 
	...
	$out = $t_item->getWithTemplate("
		<div class='accession'>
			...
			<div id='mediar'>^ca_object_representations.media.small</div>");
				...
				<div class='lexicon3d'><div class='lexicon3l'> Lexicon: </div>";
				  $lastitem=count($lex_item_array)-1;
					foreach($lex_item_array as $key=>$item){
						if ($key>0){$leftmargin="style='margin-left:25px;height:20px;'";}else{$leftmargin="style='margin-left:5px; height:20px;font-size:16px'";}
						if ($key !=$lastitem and $key>0){$spacer ="<span class='arrowr'>&nbsp;&nbsp;&nbsp;</span>";}else{$spacer="";}
						if ($key == $lastitem){$leftmargin="style='margin:25px;height:50px; border-radius:25px;line-height:150%'";}
...
<style type='text/css'>
 ...
 #titled        {width:300px; height:20px; font-size:16px; word-wrap: break-word;position: absolute;	
                 top: 85px; left: 90px;}
 ...
 #othernumberd  {width:100px; height:20px; font-size:12px; word-wrap: break-word;position: absolute;	
                 top: 107px; left: 90px;}                 
 #lexicon3      {width:230px; height:100px;margins:10px; position: absolute;border:2px solid black; 
                 top: 30px; left: 280px;}	
   .lexicon3l   {width:60px; height:20px; font-size:16px; margin-left:10px;text-align:left; font-weight:bold;display:inline;}    
   .lexicon3d   {width:230px;height:100px; text-align:left;}
   .lexicon3t   {width:230px;  font-size:13px; word-wrap: break-word;display:inline;}
 ...
 #location      {width:710px; height:60px; position: absolute; 
                 top: 350px; left: 0px;}    				
   .locationl   {width:85px; height:25px; font-size:16px; text-align:right; font-weight:bold; display:inline-block;}    		
   .locationd   {width:510px; height:60px; font-size:16px; word-wrap: break-word; display:inline-block;}
 ...
 #descriptionl  {width:85px; height:20px; font-size:16px; text-align:right; font-weight:bold; position: absolute; 
                 top: 250px; left: 0px; }    
 #descriptiond  {width:700px; height:20px; font-size:16px; word-wrap: break-word; position: absolute; 
                 top: 250px; left: 90px;display:inline-block;}
 ...
 #provenance2   {width:750px; height:200px;position: absolute; 
                 top: 50px; left: 0px; 	}
   .provenancel {width:85px; height:20px; font-size:16px; text-align:right; font-weight:bold; display:inline-block;}                
   .provenanced {width:650px;font-size:14px;padding-left:5px;display:inline-block;}
 ...
 #status        {width:450px; height:20px; position: absolute; 
                 top: 30px; left: 525px;}  
   .statusl     {width:50px; height:20px; font-size:16px; text-align:right; font-weight:bold; display:inline-block; vertical-align: text-bottom;}    
   .statusd     {width:350px;	font-size:14px;	text-align:left; display:inline-block;}
