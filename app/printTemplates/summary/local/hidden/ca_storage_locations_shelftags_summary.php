 ...
 *
 * @name PHS Shelf Tags Summary V1.0.4
 * @type page
 * @pageSize letter
 ...
 */
  global $rowcount,$rowsperpage,$recursivelimit;
	$version = "PHS Shelf Tags Summary V1.0.4"; 
								...
								*/
									$out .="
			 						<div class='tagrow'>	
   				   					...
   				   					<div class='col_barcode'></div>
		   				  			<div class='col_name'>".$the_object->get('ca_objects.preferred_labels')."&nbsp;</div>
   				   					<div class='col_image'>".$the_object->get('ca_object_representations.related.media.tiny.default')."</div>
	...
	foreach ($va_storage_children as $va_key => $va_storage_children_id) {
			...
			*/
			...
			$out .="
			 		<div class='tagrow'>
   				   <div class='col_box'><div class='box'>&nbsp;</div></div>
   				   <div class='col_case'>".$t_storage_location->get('ca_storage_locations.idno')."
   				      $storagetypehtml
   				   </div>
						 <div class='col_barcode'></div>
   				   <div class='col_name'>".$t_storage_location->get('ca_storage_locations.preferred_labels')."</div>
   				   <div class='col_image'>".$t_storage_location->get('ca_object_representations.media.tiny.default')."</div>
   				   <div class='col_location'>".print_r($this_storage,1)."
