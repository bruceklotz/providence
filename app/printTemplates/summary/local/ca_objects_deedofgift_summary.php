 ...
 *
 * @name PHS_Deed_of_Gift_V1.0.5_Summary
 * @type page 
 * @pageSize letter
 * @pageOrientation portrait
 * @tables ca_objects, ca_object__lots
 *
 * @marginTop 0.75in
 * @marginLeft 0.25in
 * @marginBottom 0.5in
 ...
 * ----------------------------------------------------------------------
 */
	$version = "PHS Deed of Gift V1.0.5 Summary"; 
	...
	$sq =  "PHS_Deed_of_Gift_".str_replace(array(' ','*','\''),'',$path).".pdf";// Remove illegal characters to add search term to the file name
	$this->setVar('filename',$sq);
	
//--- Only retrieve the correct type of record:
   $from_array	= $t_item->get('ca_objects.deed_of_gift', array('convertCodesToDisplayText' => true,'returnWithStructure' => true));
