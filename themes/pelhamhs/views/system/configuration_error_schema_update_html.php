<?php
/** ---------------------------------------------------------------------
 * themes/default/views/system/configuration_error_schema_update_html.php : pelhamhs.org
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
<head>
	...
	<link href='<?php print $vs_path; ?>/assets/fontawesome/css/font-awesome.min.css' rel='stylesheet' type='text/css' media='all'/>
</head>
<body>
	<div id='box'>
