<?php
/* ----------------------------------------------------------------------
 * themes/default/views/dashboard/dashboard_html.php : PELHAMHS.ORG V1.0.0
 * ----------------------------------------------------------------------
 * CollectiveAccess
...
<div id="dashboardControls">
	<div id="clearDashboardControl" style="float: left;">
		...
		<?php /*  This requires a modified /app/controllers/DashboardController.php, /app/lib/DashboardManager.php, /assets/ca/ca.dashboard.js ...    */
